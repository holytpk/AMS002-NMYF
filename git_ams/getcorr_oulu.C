...
//Consider the fact of different rigidity cutoff and altitude
...
void getcorr_oulu(){
   ...
   oulufit->SetMarkerSize(1.1);
   oulufit->GetXaxis()->SetNoExponent(true);
   oulufit->GetXaxis()->SetMoreLogLabels(true);
   oulufit->SetLineColor(oulufit->GetMarkerColor());
   ...
   oulucorr->SetMarkerSize(1.1);
   oulucorr->GetXaxis()->SetNoExponent(true);
   oulucorr->GetXaxis()->SetMoreLogLabels(true);
   oulucorr->SetLineColor(oulucorr->GetMarkerColor());
   ...
   oulufit2->SetMarkerSize(1.1);
   oulufit2->GetXaxis()->SetNoExponent(true);
   oulufit2->GetXaxis()->SetMoreLogLabels(true);
   oulufit2->SetLineColor(oulufit2->GetMarkerColor());
   //oulufit->GetXaxis()->SetTitleSize(0.4);
   oulufit2->Draw("AP");
   c3->cd(4);
   gPad->SetLogx();  
   ...
   oulucorr2->SetMarkerSize(1.1);
   oulucorr2->GetXaxis()->SetNoExponent(true);
   oulucorr2->GetXaxis()->SetMoreLogLabels(true);
   oulucorr2->SetLineColor(oulucorr2->GetMarkerColor());
   //oulucorr->GetXaxis()->SetTitleSize(0.4);
   ...
   alt_fit->SetMarkerSize(1.1);
   alt_fit->GetXaxis()->SetNoExponent(true);
   alt_fit->GetXaxis()->SetMoreLogLabels(true);
   alt_fit->SetLineColor(alt_fit->GetMarkerColor());
   alt_fit->Draw("AP");
   c4->cd(2);  
   gPad->SetLogx();
   gPad->SetGrid();
   ...
   alt_corr->SetMarkerSize(1.1);
   alt_corr->GetXaxis()->SetNoExponent(true);
   alt_corr->GetXaxis()->SetMoreLogLabels(true);
   alt_corr->SetLineColor(alt_corr->GetMarkerColor());
   alt_corr->Draw("AP");
   c4->cd(3);
   gPad->SetLogx();
   gPad->SetGrid();
   ...
   alt_fit2->SetMarkerSize(1.1);
   alt_fit2->GetXaxis()->SetNoExponent(true);
   alt_fit2->GetXaxis()->SetMoreLogLabels(true);
   alt_fit2->SetLineColor(alt_fit2->GetMarkerColor());
   alt_fit2->Draw("AP");
   c4->cd(4);
   gPad->SetLogx();
   gPad->SetGrid();
   ...
   alt_corr2->SetMarkerSize(1.1);
   alt_corr2->GetXaxis()->SetNoExponent(true);
   alt_corr2->GetXaxis()->SetMoreLogLabels(true);
   alt_corr2->SetLineColor(alt_corr2->GetMarkerColor());
   alt_corr2->Draw("AP");
