...
void getcorr_sopo(){
   ...
   sopofit->SetMarkerSize(1.1);
   sopofit->GetXaxis()->SetNoExponent(true);
   sopofit->GetXaxis()->SetMoreLogLabels(true);
   sopofit->SetLineColor(sopofit->GetMarkerColor());
   ...
   sopocorr->SetMarkerSize(1.1);
   sopocorr->GetYaxis()->SetRangeUser(0.8, 1.);
   sopocorr->GetXaxis()->SetNoExponent(true);
   sopocorr->GetXaxis()->SetMoreLogLabels(true);
   sopocorr->SetLineColor(sopocorr->GetMarkerColor());
   ...
   sopofit2->SetMarkerSize(1.1);
   sopofit2->GetXaxis()->SetNoExponent(true);
   sopofit2->GetXaxis()->SetMoreLogLabels(true);
   sopofit2->SetLineColor(sopofit2->GetMarkerColor());
   //sopofit->GetXaxis()->SetTitleSize(0.4);
   sopofit2->Draw("AP");
   c3->cd(4);
   gPad->SetLogx();
   ...
   sopocorr2->SetMarkerSize(1.1);
   sopocorr2->GetYaxis()->SetRangeUser(0.8, 1.);
   sopocorr2->GetXaxis()->SetNoExponent(true);
   sopocorr2->GetXaxis()->SetMoreLogLabels(true);
   sopocorr2->SetLineColor(sopocorr2->GetMarkerColor());
   //sopocorr->GetXaxis()->SetTitleSize(0.4);
