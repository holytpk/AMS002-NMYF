...
*/
	...
	for (int i=0; i<1; ++i){
		...
		for (int k=0; k<1; ++k){ 
			...
			HistTools::SetStyle(g_ave_residual_ace_rig, kPink, kFullCircle, 1.1, 1, 1); 
			HistTools::SetStyle(g_ave_residual_ams_rig, kBlue, kFullCircle, 1.1, 1, 1); 
		...
		c3->Print(Form("./data/ACE/fill/compare_fake_%s_p2_ams.png", element)); 
