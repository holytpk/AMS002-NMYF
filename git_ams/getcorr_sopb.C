...
void getcorr_sopb(){
   ...
   sopbfit->SetMarkerSize(1.1);
   sopbfit->GetXaxis()->SetNoExponent(true);
   sopbfit->GetXaxis()->SetMoreLogLabels(true);
   sopbfit->SetLineColor(sopofit->GetMarkerColor());
   ...
   sopbcorr->SetMarkerSize(1.1);
   sopbcorr->GetYaxis()->SetRangeUser(0.8, 1.);
   sopbcorr->GetXaxis()->SetNoExponent(true);
   sopbcorr->GetXaxis()->SetMoreLogLabels(true);
   sopbcorr->SetLineColor(sopbcorr->GetMarkerColor());
   ...
   sopbfit2->SetMarkerSize(1.1);
   sopbfit2->GetXaxis()->SetNoExponent(true);
   sopbfit2->GetXaxis()->SetMoreLogLabels(true);
   sopbfit2->SetLineColor(sopbfit2->GetMarkerColor());
   //sopbfit->GetXaxis()->SetTitleSize(0.4);
   sopbfit2->Draw("AP");
   c3->cd(4);
   gPad->SetLogx();
   ...
   sopbcorr2->SetMarkerSize(1.1);
   sopbcorr2->GetYaxis()->SetRangeUser(0.8, 1.);
   sopbcorr2->GetXaxis()->SetNoExponent(true);
   sopbcorr2->GetXaxis()->SetMoreLogLabels(true);
   sopbcorr2->SetLineColor(sopbcorr2->GetMarkerColor());
   //sopbcorr->GetXaxis()->SetTitleSize(0.4);
